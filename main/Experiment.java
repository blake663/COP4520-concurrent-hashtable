...
public class Experiment {
    public static void main(String[] args) throws ParseException, InterruptedException {
        ...
        System.out.println(String.format("Threaded locking hashtable took %d milliseconds to perform 64708 inserts, 129416 searchs, and 64708 deletes", duration/1000000));
...
class UnthreadedExperiment implements Runnable {
    ...
    public void run() {
        ...
        System.out.println(String.format("Unthreaded standard hashtable took %d milliseconds to perform 64708 inserts, 129416 searchs, and 64708 deletes", duration/1000000));
        System.out.println(String.format("Insertion failed %d times, and deletion failed %d times.", insertion_failures, removal_failures));
    }
}
